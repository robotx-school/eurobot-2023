...
#sys.path.append('/home/pi/EB/eurobot-2023/PathFinding/theta*')
    ...
    def check_obstacle(self, obstacles, start_point, dest_point):
        ...
        for obstacle in obstacles:
            if obstacle[0] != -1 and obstacle[1] != -1:
                obstacle_polygon = Polygon([(obstacle[0] - 5, obstacle[1] - 5), (obstacle[0] + 5, obstacle[1] - 5), (obstacle[0] + 5, obstacle[1] + 5), (obstacle[0] - 5, obstacle[1] + 5)])
