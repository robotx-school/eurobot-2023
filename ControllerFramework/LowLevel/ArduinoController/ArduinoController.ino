...
void loop () {
  ...
  if (spiTranferEnd) {
    ...
    Serial.print('\t');
    Serial.print(int_data[2]);
    Serial.print('\t');
    Serial.print(int_data[3]);
    Serial.print('\t');
    Serial.print(int_data[4]);
    Serial.print('\t');
    Serial.print(int_data[5]);
    Serial.print('\t');
    Serial.print(int_data[6]);
    Serial.print('\t');
    Serial.print(int_data[7]);
    Serial.print('\t');
    Serial.print(int_data[8]);
    Serial.print('\t');
    Serial.print(int_data[9]);
    Serial.print('\t');
    Serial.print(int_data[10]);
    Serial.println();
    switch(int_data[0]){
      case 0:
        break;
