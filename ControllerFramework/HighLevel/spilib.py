...
def move_robot(dir_, interpreter_control_flag, speed=500, accel=500, distance=1000, verbose=True, sensor_id=-1, sensor_val=None):
    send_data = []
    """
    Moves a robot
...
def stop_robot():
    # Emegency stop; based on task rewriting in low-level
